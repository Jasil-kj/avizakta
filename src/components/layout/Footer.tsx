        ...
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center gap-4 mb-8">
            <Image 
              ...
              width={200}
              height={128}
              className="h-32 md:h-40 lg:h-48 w-auto object-contain mix-blend-screen -ml-2" 
              alt="Avizakta Logo"
            />
          </div>
          ...
          <div className="flex gap-4">
            <Link
              ...
              aria-label="Avizakta on WhatsApp"
              className="w-12 h-12 md:w-10 md:h-10 glass-panel flex items-center justify-center gold-border hover:bg-primary/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Avizakta on Instagram"
              className="w-12 h-12 md:w-10 md:h-10 glass-panel flex items-center justify-center gold-border hover:bg-primary/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              <InstagramIcon className="text-primary" size={18} />
            </Link>
            <Link
              href="https://www.facebook.com/share/181RDQFZSc/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Avizakta on Facebook"
              className="w-12 h-12 md:w-10 md:h-10 glass-panel flex items-center justify-center gold-border hover:bg-primary/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              <FacebookIcon className="text-primary" size={18} />
            </Link>
          </div>
        </div>
        <div>
          ...
          <ul className="space-y-6 text-on-surface-variant text-sm">
            <li>
              <Link href="#" className="inline-block py-2 hover:text-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
                decobox.store
              </Link>
            </li>
            <li>
